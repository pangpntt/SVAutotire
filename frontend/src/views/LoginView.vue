            ...
            <div class="subtitle mt-4">
              <form method="get" class="">
                <div class="field ">
                  ...
                  <div class="control">
                    <input class="input" type="text" placeholder="กรอกชื่อผู้ใช้งาน" v-model="$v.username.$model"
                      :class="{ 'is-danger': $v.username.$error }">
                  </div>
                  <template v-if="$v.username.$error">
                    <p class="help is-danger" v-if="!$v.username.required">ชื่อผู้ใช้งาน จำเป็นต้องกรอก</p>
                    <p class="help is-danger" v-if="!$v.username.minLength">ชื่อผู้ใช้งาน ต้องมีขนาดอย่างน้อย 5 ตัวอักษร
                    </p>
                ...
                <div class="field mt-5">
                  ...
                  <div class="control">
                    <input class="input" type="password" placeholder="กรอกรหัสผ่าน" v-model="$v.password.$model"
